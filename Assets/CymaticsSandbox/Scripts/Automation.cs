...
public static class Automation
{
    ...
    public static void AutomateSceneSetup()
    {
        try
        {
            ...
            string materialsPath = "Assets/CymaticsSandbox/Materials";
            if (!AssetDatabase.IsValidFolder(materialsPath))
            {
                AssetDatabase.CreateFolder("Assets/CymaticsSandbox", "Materials");
            }
            ...
            AssetDatabase.CreateAsset(trayMat, materialsPath + "/TrayMat.mat");
